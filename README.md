...
<h3>Home Page</h3>
       ...
       <h3>Chat Interface</h3>
        ...
        <ul>
            <li><strong>Email:</strong> <a href="mailto:support@ragchatbot.com">support@ragchatbot.com</a> (placeholder)</li>
            <li><strong>GitHub Issues:</strong> <a href="#">[Link to your GitHub Issues page]</a></li>
        </ul>
    </div>
